    ...
    <div>
      ...
      <section className="mx-auto max-w-6xl px-6 pt-16 pb-12 sm:pt-24">
        ...
        <h1 className="mt-4 max-w-2xl font-serif text-4xl leading-[1.1] sm:text-6xl">
          The right paper for every page.
        </h1>
        <p className="mt-5 max-w-lg text-muted">
          From the {BRAND.location} branch to your supply closet — copy paper,
          cardstock, photo stock, envelopes, and specialty sheets, priced by the
          ream. Free shipping over {BRAND.currencySymbol}75.
        </p>
        <Link
          href="/products"
