...
export default async function AccountPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-12">
      <h1 className="font-serif text-3xl">Demo shopper</h1>
      <p className="mt-3 text-muted">
        This demo has no real login. Pick a seeded customer to browse and check
        out as them. Each has an API token your AI agent can use as
